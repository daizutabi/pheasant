...
def test_code_parse_source_copy_number(parse):
    ...
    answer = "".join(
        [
            ...
            '<h1><span class="pheasant-header-number">1.</span> '
            '<span class="pheasant-header-title">Title</span></h1>\n'
            '<h2><span class="pheasant-header-number">1.1.</span> '
            '<span class="pheasant-header-title">Section</span></h2>\nText\n'
        ]
    )
    print(output)
    assert output == answer
